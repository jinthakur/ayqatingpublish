<%@ Page Title="Register an external login" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalAccount/Login.aspx.cs" Inherits="MAMIH.Account.RegisterExternalLogin" Async="true" %>
...
<h3>Register with your <%: ProviderName %> account</h3>
    ...
    <asp:PlaceHolder runat="server">
        <div class="form-group">
            ...
            <hr />
            <a id="ctl00_MainContent_NewUserWizard_CreateUserStepContainer_HyperLink1" href="//www.ayqdating.com/Registrationterms.aspx" target="_blank">Clicking on Log in  button implies that User accept all Terms and Conditions</a>
            <a href="../Registrationterms.aspx">I Confirm Registration terms</a>
            <hr />
            <asp:ValidationSummary runat="server" ShowModelStateErrors="true" CssClass="text-danger" />
            <p class="text-info">
                You've authenticated with <label class="control-label " ><%: ProviderName %></label>. Please enter an email below for the current site
         ...
         <select style="width: 177px;" id="Country" name="Country" runat="server">
            ...
            <div class="form-group">
                <div class="col-md-offset-2 col-md-10">
                  <asp:Button CssClass="btn btn-primary" runat="server" Text="Log in"  OnClick="LogIn_Click" />
                </div>
            </div>
        </div>
    </asp:PlaceHolder>
